...
applies_to: [solana]
sources:
  - "Jupiter Swap API - https://github.com/jup-ag/jupiter-swap-api-client , https://dev.jup.ag (verified 2026-08-25)"
  - "Yellowstone gRPC - https://github.com/rpcpool/yellowstone-grpc (verified 2026-08-25)"
  - "Helius LaserStream/DAS/Webhooks - https://github.com/helius-labs/laserstream-sdk , https://www.helius.dev/docs (verified 2026-08-25)"
  - "Jito Labs Block Engine + ShredStream - https://github.com/jito-labs/jito-ts , https://github.com/jito-labs/searcher-examples , https://github.com/jito-labs/shredstream-proxy (verified 2026-08-25)"
  - "Carbon (sevenlabs-hq) - https://github.com/sevenlabs-hq/carbon (verified 2026-08-25)"
  - "Substreams for Solana (StreamingFast) - https://github.com/streamingfast/substreams-solana (verified 2026-08-25)"
  - "Pyth Network SDK - https://github.com/pyth-network/pyth-sdk-rs (verified 2026-08-25)"
  - "Jupiter Price API + Birdeye Data API - https://dev.jup.ag/docs/price , https://docs.birdeye.so (verified 2026-08-25)"
  - "grammY - https://github.com/grammyjs/grammY (verified 2026-08-25)"
  - "sol-trade-sdk (0xfnzero) - https://github.com/0xfnzero/sol-trade-sdk (verified 2026-08-25)"
...
- Audit status: routed venues carry their own audits; Jupiter's aggregation program itself has had reviews not centrally published per-repo - re-verify
- License: jupiter-swap-api-client repo shows no LICENSE file in the GitHub UI (unknown - re-verify before redistributing the client itself); the API is a hosted service gated by ToS + API key, not code you fork
- Maintenance: active jup-ag org, 199 stars on the Rust client, frequent API changelog entries (2026 pricing/lite-api changes ongoing) - re-verify exact recency
...
- Known pitfalls: free lite-api tier has fair-use rate limits that bite under bot-scale polling; needs a paid portal.jup.ag key for production volume; quote staleness under volatility requires slippage + priority-fee tuning on the bot side.
...
- License: AGPL-3.0 - FLAG: strong copyleft on the plugin/repo; if you self-host the plugin as a network-accessible service, AGPL's network-use clause can require you to offer source to your users - legal review needed before bundling into a closed product. The hosted-provider path (Helius/Triton/QuickNode reselling gRPC access) sidesteps this since you're a client, not a redistributor.
- Maintenance: active rpcpool/Triton org, 989 stars, 442+ commits, regular CHANGELOG entries - re-verify exact recency
...
- License: laserstream-sdk repo is MIT (permissive); the DAS/Webhooks API itself is a paid hosted service gated by API key, not forkable code
- Maintenance: active helius-labs org, 58 stars / 331+ commits on laserstream-sdk - re-verify exact recency
...
- License: Apache-2.0 across all three repos (jito-ts, searcher-examples, shredstream-proxy) - permissive, no copyleft concerns
- Maintenance: active jito-labs org - jito-ts 197 stars/52 commits, searcher-examples 431 stars/35 commits, shredstream-proxy 245 stars/80 commits - re-verify exact recency
...
- License: MIT
- Maintenance: active sevenlabs-hq org, 614+ stars, 1,425+ commits, v1.0.0 released mid-2025 and presented at Solana Accelerate/Breakpoint 2025 - re-verify exact recency
...
- License: Apache-2.0
- Maintenance: StreamingFast org, but the Solana-specific repo is comparatively small (19 stars, 65 commits) next to the core substreams project - treat as maintained-but-niche, re-verify before betting critical infra on it
...
- Audit status: Pyth's on-chain program/oracle design has undergone external review as core Solana ecosystem infra (widely relied upon); re-verify current audit report links before treating as gospel for high-value liquidation logic
- License: Apache-2.0
- Maintenance: active pyth-network org, 114+ stars/226+ commits on pyth-sdk-rs, pyth-crosschain is the actively-growing successor repo - re-verify exact recency
...
- License: n/a - both are ToS-gated hosted services, not forkable code; the community birdeye-py wrapper is a separate MIT-licensed convenience client, not official
- Maintenance: Jupiter Price API actively iterating (v3, lite-api pricing changes ongoing into 2026); Birdeye actively selling API access with a maintained websocket product - re-verify current rate limits/pricing before committing
...
- License: MIT
- Maintenance: very active, 3.7k stars, 943+ commits, strong docs and plugin ecosystem - one of the best-maintained repos in this list, re-verify exact recency
...
- License: MIT
- Maintenance: 336 stars, 642+ commits - reasonably active for this niche, re-verify exact recency before depending on it
